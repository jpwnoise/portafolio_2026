  ...
  return (
    <main id="home" className="flex flex-col items-center bg-linear-to-b from-gray-100 via-blue-100 to-white">
      ...
      <motion.div 
        ...
        className="w-full max-w-4xl bg-gradient-to-b from-gray-200 via-gray-400/60 to-gray-300 flex flex-col items-center justify-center p-6 rounded-lg mt-8 border border-blue-400 shadow-lg"
      >
        <p className="text-6xl -rotate-45 sticky -translate-x-80 translate-y-8 text-blue-600/50 text-center font-[var(--font-great-vibes)]" style={{ fontFamily: "var(--font-great-vibes)" }}>
          Desarrollo 
          <br />
          Con pasión 
        </p>
        ...
        <div className="relative z-10 group">
          <ContactImage borderColor="bg-blue-400"/>
        </div>
